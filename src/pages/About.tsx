              ...
              <div className="row justify-content-xl-center">
                <div className="col-12 col-xl-11">
                  ...
                  <p className="lead fs-5 text-secondary mb-3">
                    At Shopping Cart, we are passionate about providing an
                    exceptional shopping experience tailored to your needs.
                    Founded with a vision to simplify online shopping, we strive
                    to offer a seamless and convenient platform for all your
                    purchasing needs.
                  </p>
                  {/* <p className="mb-5">
                  ...
                  <div className="row gy-4 gy-md-0 gx-xxl-5X">
                    ...
                    <div className="col-12 col-md-6">
                      <div className="d-flex">
                        ...
                        <div>
                          <h2 className="h4 mb-3">Digital Shopping</h2>
                          <p className="text-secondary mb-0">
